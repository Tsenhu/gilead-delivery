...
#===================================Main function
setwd("//chofile/Applications/ETLKCI/ETLUserSource/Gilead/")
...
for(pro in 1:length(form_folder))
{
  ...
  input_path=paste0("//chofile/Applications/ETLKCI/ETLUserSource/Gilead/",form_folder[pro],"/Input_Folder")
  output_path=paste0("//chofile/Applications/ETLKCI/ETLUserSource/Gilead/",form_folder[pro],"/Output_Folder")
  ...
  est_path="C:/Users/hucen/GitHub/pro/python/Gilead_XML/badass"
